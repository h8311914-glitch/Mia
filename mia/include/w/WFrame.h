 ...
 */
o_inline WFrame *WFrame_new(oobj parent)
 ...
 * The children are placed inside the frame.
 */
...
/**
 * @param obj WFrame object
 * @return stroke of the borders "ltrb", <=0 to hide
 */
OObj_DECL_GETSETREF(WFrame, vec4, border_size)
