 ...
 * WObj_tooltip is set to "" to ignore picks behind the pane
 */
 ...
 */
o_inline WPane *WPane_new(oobj parent)
 ...
 * The children are placed inside the pane.
 */
vec2 WPane__v_update(oobj obj, vec2 lt, vec2 min_size, bool enabled, oobj theme, a_pointer__fn pointer_fn);
