 ...
 *
 * Double click to set the progress to that clicked pos.
 */
 ...
 */
o_inline WDrag *WDrag_new(oobj parent)
{
...
/**
* Virtual implementation that handles and renders the drag field.
 * Calls WObj__update_children_stacked.
 * The children are placed in the drag field center.
 */
