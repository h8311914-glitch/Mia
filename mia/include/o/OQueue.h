...
/**
 * Creates a new OQueue object
 * @param parent to inherit from
 * @param data The OArray to work on
 * @return The new object
 * @note Only use OQueue_ functions when working on the given OArray (in multithread context)
 */
o_inline OQueue *OQueue_new(oobj parent, oobj data)
{
 ...
 * @threadsafe
 */
o_inline void OQueue_append_front(oobj obj, const void *opt_elements_data, osize num)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_take_front(oobj obj, void *out_opt_elements_data, osize num)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_take_front_try(oobj obj, void *out_elements_data, osize num)
{
 ...
 * @threadsafe
 */
o_inline void OQueue_push(oobj obj, const void *element_data)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_pop(oobj obj, void *out_opt_element_data)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_pop_try(oobj obj, void *out_opt_element_data)
{
 ...
 * @threadsafe
 */
o_inline void OQueue_push_at(oobj obj, osize idx, const void *element_data)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_pop_at(oobj obj, osize idx, void *out_opt_element_data)
{
 ...
 * @threadsafe
 */
o_inline bool OQueue_pop_at_try(oobj obj, osize idx, void *out_opt_element_data)
{
 ...
 * @note element_size should match OQueue_element_size(obj)
 */
o_inline void OQueue_push_front(oobj obj, const void *element_data)
{
 ...
 * @note element_size should match OQueue_element_size(obj)
 */
o_inline bool OQueue_pop_front(oobj obj, void *out_opt_element_data)
{
 ...
 * @return False if failed
 */
o_inline bool OQueue_pop_front_try(oobj obj, void *out_opt_element_data)
{
