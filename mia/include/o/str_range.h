...
#define o_str_range_list_new_a(list_len) o_str_range_list_new(o_arena(), (list_len))
...
#define o_str_range_list_list_new_a(list_list_len, list_len) \
    o_str_range_list_list_new(o_arena(), (list_list_len), (list_len))
 ...
 */
o_inline osize o_str_ranges_size(const struct o_str_range *ranges)
{
    osize cnt = 0;
 ...
 */
o_inline struct o_str_range_list o_str_ranges_as_list(struct o_str_range *ranges, oobj parent)
{
...
#define o_str_ranges_to_strings_a(str, ragnes, opt_len) \
    o_str_ranges_to_strings(o_arena(), (str), (ragnes), (opt_len))
...
char *o_str_ranges_replace(oobj obj, const char *str,
                           ...
                           const char *replace);
#define o_str_ranges_replace_a(str, ranges, opt_len, replace) \
    o_str_ranges_replace(o_arena(), (str), (ranges), (opt_len), (replace))
