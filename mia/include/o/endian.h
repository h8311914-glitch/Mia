...
o_inline bool o_endian_system_is_binary_little_endian(void) {
    int n = 1;
 ...
 * @param n maximal 256 bytes
 */
o_inline void o_endian_swap(void *buf, int n) {
    assert(n <= 256 && "o_endian_swap: max 256 bytes");
    char tmp[256];
 ...
 */
o_inline ou16 ou16_endian_to_big(ou16 x) {
    ou16 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[0] = (x >> 8) & 0xFF;
 ...
 */
o_inline ou16 ou16_endian_to_lil(ou16 x) {
    ou16 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[1] = (x >> 8) & 0xFF;
 ...
 */
o_inline ou16 ou16_endian_from_lil(ou16 x) {
    ou16 result;
    ou8 *c;
 ...
 * @return x in host endian
 */
o_inline ou16 ou16_endian_from_big(ou16 x) {
    ou16 result;
    ou8 *c;
 ...
 * @return x as big endian
 */
o_inline ou32 ou32_endian_to_big(ou32 x) {
    ou32 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[0] = (x >> 24) & 0xFF;
 ...
 * @return x as little endian
 */
o_inline ou32 ou32_endian_to_lil(ou32 x) {
    ou32 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[3] = (x >> 24) & 0xFF;
 ...
 * @return x in host endian
 */
o_inline ou32 ou32_endian_from_lil(ou32 x) {
    ou32 result;
    ou8 *c;
 ...
 * @return x in host endian
 */
o_inline ou32 ou32_endian_from_big(ou32 x) {
    ou32 result;
    ou8 *c;
 ...
 * @return x as big endian
 */
o_inline ou64 ou64_endian_to_big(ou64 x) {
    ou64 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[0] = x >> 56;
 ...
 * @return x as little endian
 */
o_inline ou64 ou64_endian_to_lil(ou64 x) {
    ou64 result;
    ou8 *c;
    c = (ou8 *) &result;
    c[7] = x >> 56;
 ...
 * @return x in host endian
 */
o_inline ou64 ou64_endian_from_lil(ou64 x) {
    ou64 result;
    ou8 *c;
 ...
 * @return x in host endian
 */
o_inline ou64 ou64_endian_from_big(ou64 x) {
    ou64 result;
    ou8 *c;
 ...
 * @return x as big endian
 */
o_inline oi16 oi16_endian_to_big(oi16 x) {
 ...
 * @return x as little endian
 */
o_inline oi16 oi16_endian_to_lil(oi16 x) {
 ...
 * @return x in host endian
 */
o_inline oi16 oi16_endian_from_lil(oi16 x) {
 ...
 * @return x in host endian
 */
o_inline oi16 oi16_endian_from_big(oi16 x) {
 ...
 * @return x as big endian
 */
o_inline oi32 oi32_endian_to_big(oi32 x) {
 ...
 * @return x as little endian
 */
o_inline oi32 oi32_endian_to_lil(oi32 x) {
 ...
 * @return x in host endian
 */
o_inline oi32 oi32_endian_from_lil(oi32 x) {
 ...
 * @return x in host endian
 */
o_inline oi32 oi32_endian_from_big(oi32 x) {
 ...
 * @return x as big endian
 */
o_inline oi64 oi64_endian_to_big(oi64 x) {
 ...
 * @return x as little endian
 */
o_inline oi64 oi64_endian_to_lil(oi64 x) {
 ...
 * @return x in host endian
 */
o_inline oi64 oi64_endian_from_lil(oi64 x) {
 ...
 * @return x in host endian
 */
o_inline oi64 oi64_endian_from_big(oi64 x) {
 ...
 * @return x as big endian
 */
o_inline of32 of32_endian_to_big(of32 x) {
    void *x_ptr = &x;
 ...
 * @return x as little endian
 */
o_inline of32 of32_endian_to_lil(of32 x) {
    void *x_ptr = &x;
 ...
 * @return x in host endian
 */
o_inline of32 of32_endian_from_lil(of32 x) {
    void *x_ptr = &x;
 ...
 * @return x in host endian
 */
o_inline of32 of32_endian_from_big(of32 x) {
    void *x_ptr = &x;
 ...
 * @return x as big endian
 */
o_inline of64 of64_endian_to_big(of64 x) {
    void *x_ptr = &x;
 ...
 * @return x as little endian
 */
o_inline of64 of64_endian_to_lil(of64 x) {
    void *x_ptr = &x;
 ...
 * @return x in host endian
 */
o_inline of64 of64_endian_from_lil(of64 x) {
    void *x_ptr = &x;
 ...
 * @return x in host endian
 */
o_inline of64 of64_endian_from_big(of64 x) {
    void *x_ptr = &x;
