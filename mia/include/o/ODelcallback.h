#ifndef O_ODELCALLBACK_H
#define O_ODELCALLBACK_H
...
/**
 * Creates a new ODelcallback object
 * @param parent to inherit from
 * @param fn the deletor callback function
 * @return The new object
 * @sa o_user_ref for passing userdata with the object
 */
o_inline ODelcallback *ODelcallback_new(oobj parent, OObj__event_fn fn)
{
 ...
 * @param log_level such as O_LOG_INFO
 * @return The new object
 */
 ...
 * @sa o_user_ref for passing userdata with the object
 */
o_inline void ODelcallback_set(oobj obj, OObj__event_fn fn)
{
