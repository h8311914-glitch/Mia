 ...
 * @return a==b
 */
o_inline bool u_color_equals(bvec4 a, bvec4 b) {
 ...
 */
o_inline bvec4 u_color_blend(bvec4 dst, bvec4 src) {
 ...
 */
o_inline vec4 u_color_to_vec4(bvec4 color) {
 ...
 */
o_inline bvec4 u_color_from_vec4(vec4 color) {
 ...
 */
o_inline bvec4 u_color_to_hsv(bvec4 rgba) {
 ...
 * @return bvec4 color as hsv
 */
o_inline bvec4 u_color_from_hsv(bvec4 hsva) {
