...
/**
 * @return default window left top padding (defaults to 8, 16)
 ...
 * @return true if the WBtn got clicked
 * @note want to get the internal WBtn? use OObj_find(x_iui_wobj(...), WBtn, NULL, oi32_MAX);
 */
