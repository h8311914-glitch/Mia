...
/**
 * Creates a new XViewText object
 * Creates an AView that renders a virtual keyboard.
 * @param parent to inherit from
 * @param title above the text edit line
 * @param show_cancel if true, enables a cancel button
 ...
 */
o_inline XViewText *XViewText_new(oobj parent, const char *title, bool show_cancel, int max_chars)
{
 ...
 */
OObj_DECL_GETSET(XViewText, bool, tex_clear_full)
