 ...
 */
o_inline RShaderQuadMerge* RShaderQuadMerge_new(oobj parent, oobj tex, bool move_tex)
...
void RShaderQuadMerge__v_render(oobj obj, oobj bound_tex, oobj program, int num, const struct r_proj* proj);
