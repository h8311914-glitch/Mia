 ...
 */
o_inline RShaderQuadChannelmerge* RShaderQuadChannelmerge_new(oobj parent,
                                                     oobj r, oobj g, oobj b, oobj a, bool move_texs)
...
void RShaderQuadChannelmerge__v_render(oobj obj, oobj bound_tex, oobj program, int num, const struct r_proj* proj);
 ...
 * @return red RTex
 */
o_inline oobj RShaderQuadChannelmerge_r(oobj obj)
{
 ...
 * @return red RTex
 */
o_inline oobj RShaderQuadChannelmerge_r_set(oobj obj, oobj r)
{
