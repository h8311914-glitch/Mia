 ...
 *       color set to R_WHITE
 */
o_inline RShaderQuadKernel *RShaderQuadKernel_new(oobj parent, oobj tex, bool move_tex,
        oobj kernel, bool move_kernel) {
...
void RShaderQuadKernel__v_render(oobj obj, oobj bound_tex, oobj program, int num, const struct r_proj *proj);
 ...
 * @return RTex kernel
 */
o_inline oobj RShaderQuadKernel_kernel(oobj obj) {
