...
_Static_assert(sizeof(m_dvec2) == sizeof(double) * 2, "wrong expected size");
...
_Static_assert(sizeof(m_dvec3) == sizeof(double) * 3, "wrong expected size");
...
_Static_assert(sizeof(m_dvec4) == sizeof(double) * 4, "wrong expected size");
...
_Static_assert(sizeof(m_dmat2) == sizeof(double) * 2 * 2, "wrong expected size");
...
_Static_assert(sizeof(m_dmat3) == sizeof(double) * 3 * 3, "wrong expected size");
...
typedef union {
    ...
    m_dvec4 col[4];
    struct {
        m_dvec4 axis_x, axis_y, axis_z, axis_t;
    };
    struct {
        double v0, v1, v2, v3;
        double v4, v5, v6, v7;
...
_Static_assert(sizeof(m_dmat4) == sizeof(double) * 4 * 4, "wrong expected size");
