...
_Static_assert(sizeof(m_bvec2) == sizeof(obyte) * 2, "wrong expected size");
...
_Static_assert(sizeof(m_bvec3) == sizeof(obyte) * 3, "wrong expected size");
...
_Static_assert(sizeof(m_bvec4) == sizeof(obyte) * 4, "wrong expected size");
