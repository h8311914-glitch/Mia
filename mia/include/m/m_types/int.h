...
_Static_assert(sizeof(m_ivec2) == sizeof(int) * 2, "wrong expected size");
...
_Static_assert(sizeof(m_ivec3) == sizeof(int) * 3, "wrong expected size");
...
_Static_assert(sizeof(m_ivec4) == sizeof(int) * 4, "wrong expected size");
