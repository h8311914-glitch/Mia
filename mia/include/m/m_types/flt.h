...
_Static_assert(sizeof(m_vec2) == sizeof(float) * 2, "wrong expected size");
...
_Static_assert(sizeof(m_vec3) == sizeof(float) * 3, "wrong expected size");
...
_Static_assert(sizeof(m_vec4) == sizeof(float) * 4, "wrong expected size");
...
_Static_assert(sizeof(m_mat2) == sizeof(float) * 2 * 2, "wrong expected size");
...
_Static_assert(sizeof(m_mat3) == sizeof(float) * 3 * 3, "wrong expected size");
...
typedef union {
    ...
    m_vec4 col[4];
    struct {
        m_vec4 axis_x, axis_y, axis_z, axis_t;
    };
    struct {
        float v0, v1, v2, v3;
        float v4, v5, v6, v7;
...
_Static_assert(sizeof(m_mat4) == sizeof(float) * 4 * 4, "wrong expected size");
