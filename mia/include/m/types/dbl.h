...
#define dmat3_(...) (dmat3) {{ \
(dvec3[]){__VA_ARGS__}[0], \
(dvec3[]){__VA_ARGS__}[o_min(1, O_VA_ARGS_COUNT(__VA_ARGS__)-1)], \
(dvec3[]){__VA_ARGS__}[o_min(2, O_VA_ARGS_COUNT(__VA_ARGS__)-1)] \
}}
...
#define dmat4_(...) (dmat4) {{ \
(dvec4[]){__VA_ARGS__}[0], \
(dvec4[]){__VA_ARGS__}[o_min(1, O_VA_ARGS_COUNT(__VA_ARGS__)-1)], \
(dvec4[]){__VA_ARGS__}[o_min(2, O_VA_ARGS_COUNT(__VA_ARGS__)-1)], \
(dvec4[]){__VA_ARGS__}[o_min(3, O_VA_ARGS_COUNT(__VA_ARGS__)-1)] \
}}
