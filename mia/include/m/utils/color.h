 ...
 */
o_inline m_vec3 vec3_rgb2hsv_unsafe(m_vec3 rgb)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_vec3 vec3_hsv2rgb_unsafe(m_vec3 hsv)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_vec3 vec3_rgb2hsv(m_vec3 rgb)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_vec3 vec3_hsv2rgb(m_vec3 hsv)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_vec4 vec4_rgb2hsv_unsafe(m_vec4 rgba)
{
    m_vec4 hsva;
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_vec4 vec4_rgb2hsv(m_vec4 rgba)
{
    m_vec4 hsva;
 ...
 **/
o_inline m_vec4 vec4_hsv2rgb_unsafe(m_vec4 hsva)
{
    m_vec4 rgba;
 ...
 * Alpha version, which will just be copied
 **/
o_inline m_vec4 vec4_hsv2rgb(m_vec4 hsva)
{
    m_vec4 rgba;
