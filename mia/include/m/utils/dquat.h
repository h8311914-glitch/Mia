...
/** m_dvec4 = [0, 0, 0, 1] */
o_inline m_dvec4 md_quat_eye(void)
{
    m_dvec4 self;
    self.x = 0;
    self.y = 0;
...
/** dst = -x, -y, -z, w */
o_inline m_dvec4 md_quat_conj(m_dvec4 q)
{
    m_dvec4 self;
    self.x = -q.x;
    self.y = -q.y;
...
/** dst = inv(m_dvec4) */
o_inline m_dvec4 md_quat_inv(m_dvec4 q)
{
...
o_inline m_dvec4 md_quat_mul(m_dvec4 q_a, m_dvec4 q_b)
{
...
o_inline m_dvec4 md_quat_from_angle_axis(m_dvec4 angle_axis)
{
...
/** angle_axis = xyz + w=angle in rad */
o_inline m_dvec4 md_quat_to_angle_axis(m_dvec4 q)
{
...
o_inline m_dmat3 md_quat_to_rotation_matrix(m_dvec4 q)
{
...
o_inline m_dvec4 md_quat_from_rotation_matrix(m_dmat3 mat)
{
...
/** returns the orientation of a 3*3 rotation matrix as m_dvec4 */
o_inline void md_quat_pose_from_pose_matrix(m_dvec3 *out_pose_pos, m_dvec4 *out_pose_quat, m_dmat4 mat_pose)
{
...
/** returns the orientation of a 3*3 rotation matrix as m_dvec4 */
o_inline m_dmat4 md_quat_pose_to_pose_matrix(m_dvec3 pose_pos, m_dvec4 pose_quat)
{
...
o_inline m_dvec3 md_quat_rotate_pos(m_dvec4 q, m_dvec3 pos)
{
    m_dvec4 p;
    p.xyz = pos;
    p.w = 0;
 ...
 */
o_inline void md_quat_pose_inv(m_dvec3 *out_pose_inv_pos, m_dvec4 *out_pose_inv_quat, m_dvec3 pose_pos, m_dvec4 pose_quat)
{
...
o_inline m_dvec3 md_quat_pose_transform_pos(m_dvec3 a_pos, m_dvec4 a_quat, m_dvec3 pos_b)
{
...
o_inline void md_quat_pose_transform_pose(m_dvec3 *out_pos, m_dvec4 *out_quat,
...
o_inline m_dvec4 md_quat_slerp(m_dvec4 q_a, m_dvec4 q_b, double t)
{
