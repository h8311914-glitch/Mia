...
o_inline m_dmat3 dmat3_rotation_from_angle_axis(m_dvec4 angle_axis)
{
...
o_inline m_dmat3 dmat3_rotation_from_dir_z(m_dvec3 dir_z)
{
...
o_inline m_dmat4 dmat4_pose_from_ray(m_dvec3 ray_start, m_dvec3 ray_dir)
{
