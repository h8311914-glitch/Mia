...
o_inline m_mat3 mat3_rotation_from_angle_axis(m_vec4 angle_axis)
{
...
o_inline m_mat3 mat3_rotation_from_dir_z(m_vec3 dir_z)
{
...
o_inline m_mat4 mat4_pose_from_ray(m_vec3 ray_start, m_vec3 ray_dir)
{
