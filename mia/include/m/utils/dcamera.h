 ...
 */
o_inline m_dmat4 dmat4_camera_ortho(double left, double right,
 ...
 * @param far_z: far flipping plane
 */
o_inline m_dmat4 dmat4_camera_frustum(double left, double right,
                             double bottom, double top,
                             double near_z, double far_z)
{
 ...
 * @param far_z: far flipping plane
 */
o_inline m_dmat4 dmat4_camera_perspective(double fovy, double aspect, double near_z, double far_z)
{
 ...
 */
o_inline m_dmat4 dmat4_camera_lookat(m_dvec3 eye, m_dvec3 center, m_dvec3 up)
{
