...
o_inline bool m_intersection_plane_plane(m_vec3 *out_pos, m_vec3 *out_dir,
...
o_inline bool m_intersection_plane_line(m_vec3 *out_pos, m_vec4 plane_hessian,
...
o_inline float m_intersection_triangle_line(m_vec3 v0, m_vec3 v1, m_vec3 v2,
                                   m_vec3 line_pos, m_vec3 line_dir,
                                   bool culling)
{
...
o_inline bool m_intersection_line_line(float *out_tau_a, float *out_tau_b,
...
o_inline float m_intersection_line_point(m_vec3 line_pos, m_vec3 line_dir, m_vec3 point)
{
...
o_inline bool intersection2_line_line(float *out_tau_a, float *out_tau_b,
...
/** returns the projection point on the line by tau. searches for the nearest distance points */
o_inline float intersection2_line_point(m_vec2 line_pos, m_vec2 line_dir, m_vec2 point)
{
