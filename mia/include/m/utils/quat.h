...
/** m_vec4 = [0, 0, 0, 1] */
o_inline m_vec4 m_quat_eye(void)
{
    m_vec4 self;
    self.x = 0;
    self.y = 0;
...
/** dst = -x, -y, -z, w */
o_inline m_vec4 m_quat_conj(m_vec4 q)
{
    m_vec4 self;
    self.x = -q.x;
    self.y = -q.y;
...
/** dst = inv(m_vec4) */
o_inline m_vec4 m_quat_inv(m_vec4 q)
{
...
o_inline m_vec4 m_quat_mul(m_vec4 q_a, m_vec4 q_b)
{
...
o_inline m_vec4 m_quat_from_angle_axis(m_vec4 angle_axis)
{
...
/** angle_axis = xyz + w=angle in rad */
o_inline m_vec4 m_quat_to_angle_axis(m_vec4 q)
{
...
o_inline m_mat3 m_quat_to_rotation_matrix(m_vec4 q)
{
...
o_inline m_vec4 m_quat_from_rotation_matrix(m_mat3 mat)
{
...
/** returns the orientation of a 3*3 rotation matrix as m_vec4 */
o_inline void m_quat_pose_from_pose_matrix(m_vec3 *out_pose_pos, m_vec4 *out_pose_quat, m_mat4 mat_pose)
{
...
/** returns the orientation of a 3*3 rotation matrix as m_vec4 */
o_inline m_mat4 m_quat_pose_to_pose_matrix(m_vec3 pose_pos, m_vec4 pose_quat)
{
...
o_inline m_vec3 m_quat_rotate_pos(m_vec4 q, m_vec3 pos)
{
    m_vec4 p;
    p.xyz = pos;
    p.w = 0;
 ...
 */
o_inline void m_quat_pose_inv(m_vec3 *out_pose_inv_pos, m_vec4 *out_pose_inv_quat, m_vec3 pose_pos, m_vec4 pose_quat)
{
...
o_inline m_vec3 m_quat_pose_transform_pos(m_vec3 a_pos, m_vec4 a_quat, m_vec3 pos_b)
{
...
o_inline void m_quat_pose_transform_pose(m_vec3 *out_pos, m_vec4 *out_quat,
...
o_inline m_vec4 m_quat_slerp(m_vec4 q_a, m_vec4 q_b, float t)
{
