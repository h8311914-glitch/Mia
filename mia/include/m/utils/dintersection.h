...
o_inline bool md_intersection_plane_plane(m_dvec3 *out_pos, m_dvec3 *out_dir,
...
o_inline bool md_intersection_plane_line(m_dvec3 *out_pos, m_dvec4 plane_hessian,
...
o_inline double md_intersection_triangle_line(m_dvec3 v0, m_dvec3 v1, m_dvec3 v2,
                                     m_dvec3 line_pos, m_dvec3 line_dir,
                                     bool culling)
{
...
o_inline bool md_intersection_line_line(double *out_tau_a, double *out_tau_b,
...
o_inline double md_intersection_line_point(m_dvec3 line_pos, m_dvec3 line_dir, m_dvec3 point)
{
...
o_inline bool dintersection2_line_line(double *out_tau_a, double *out_tau_b,
...
/** returns the projection point on the line by tau. searches for the nearest distance points */
o_inline double dintersection2_line_point(m_dvec2 line_pos, m_dvec2 line_dir, m_dvec2 point)
{
