 ...
 */
o_inline m_mat4 mat4_camera_ortho(float left, float right,
 ...
 * @param far_z: far flipping plane
 */
o_inline m_mat4 mat4_camera_frustum(float left, float right,
                           float bottom, float top,
                           float near_z, float far_z)
{
 ...
 * @param far_z: far flipping plane
 */
o_inline m_mat4 mat4_camera_perspective(float fovy, float aspect, float near_z, float far_z)
{
 ...
 */
o_inline m_mat4 mat4_camera_lookat(m_vec3 eye, m_vec3 center, m_vec3 up)
{
