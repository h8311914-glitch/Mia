 ...
 */
o_inline m_dvec3 dvec3_rgb2hsv_unsafe(m_dvec3 rgb)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_dvec3 dvec3_hsv2rgb_unsafe(m_dvec3 hsv)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_dvec3 dvec3_rgb2hsv(m_dvec3 rgb)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_dvec3 dvec3_hsv2rgb(m_dvec3 hsv)
{
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_dvec4 dvec4_rgb2hsv_unsafe(m_dvec4 rgba)
{
    dvec4 hsva;
 ...
 * all components are in the range [0:1] including hue.
 **/
o_inline m_dvec4 dvec4_rgb2hsv(m_dvec4 rgba)
{
    dvec4 hsva;
 ...
 **/
o_inline m_dvec4 dvec4_hsv2rgb_unsafe(m_dvec4 hsva)
{
    dvec4 rgba;
 ...
 * Alpha version, which will just be copied
 **/
o_inline m_dvec4 dvec4_hsv2rgb(m_dvec4 hsva)
{
    dvec4 rgba;
