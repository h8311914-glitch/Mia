 ...
 */
o_inline osize dvec4_buffer(char *str, osize size, m_dvec4 dvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the dvec<n> type (2..4)
 */
o_inline char *dvec4_str(oobj parent, m_dvec4 dvec, bool colored, bool typed)
{
    return dvecn_str(parent, dvec.v, 4, colored, typed);
}
#define dvec4_str_a(dvec, colored, typed) dvec4_str(o_arena(), (dvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize dvec4_print(m_dvec4 dvec)
{
 ...
 * @param n the size
 */
o_inline osize dvec4_println(m_dvec4 dvec)
{
 ...
 */
o_inline bool dvec4_json_read(m_dvec4 *out_dvec, oobj json_array)
{
 ...
 * @example json: [1.1, 2.2, 3.3, 4.4]
 */
o_inline oobj dvec4_json_new(oobj parent, const char *name, m_dvec4 dvec)
{
