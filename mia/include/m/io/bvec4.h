 ...
 */
o_inline osize bvec4_buffer(char *str, osize size, m_bvec4 bvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the bvec<n> type (2.)
 */
o_inline char *bvec4_str(oobj parent, m_bvec4 bvec, bool colored, bool typed)
{
    return bvecn_str(parent, bvec.v, 4, colored, typed);
}
#define bvec4_str_a(bvec, colored, typed) bvec4_str(o_arena(), (bvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize bvec4_print(m_bvec4 bvec)
{
 ...
 * @param n the size
 */
o_inline osize bvec4_println(m_bvec4 bvec)
{
 ...
 */
o_inline bool bvec4_json_read(m_bvec4 *out_bvec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj bvec4_json_new(oobj parent, const char *name, m_bvec4 bvec)
{
