 ...
 */
o_inline osize bvec2_buffer(char *str, osize size, m_bvec2 bvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the bvec<n> type (2.)
 */
o_inline char *bvec2_str(oobj parent, m_bvec2 bvec, bool colored, bool typed)
{
    return bvecn_str(parent, bvec.v, 2, colored, typed);
}
#define bvec2_str_a(bvec, colored, typed) bvec2_str(o_arena(), (bvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize bvec2_print(m_bvec2 bvec)
{
 ...
 * @param n the size
 */
o_inline osize bvec2_println(m_bvec2 bvec)
{
 ...
 */
o_inline bool bvec2_json_read(m_bvec2 *out_bvec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj bvec2_json_new(oobj parent, const char *name, m_bvec2 bvec)
{
