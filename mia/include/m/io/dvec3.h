 ...
 */
o_inline osize dvec3_buffer(char *str, osize size, m_dvec3 dvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the dvec<n> type (2..4)
 */
o_inline char *dvec3_str(oobj parent, m_dvec3 dvec, bool colored, bool typed)
{
    return dvecn_str(parent, dvec.v, 3, colored, typed);
}
#define dvec3_str_a(dvec, colored, typed) dvec3_str(o_arena(), (dvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize dvec3_print(m_dvec3 dvec)
{
 ...
 * @param n the size
 */
o_inline osize dvec3_println(m_dvec3 dvec)
{
 ...
 */
o_inline bool dvec3_json_read(m_dvec3 *out_dvec, oobj json_array)
{
 ...
 * @example json: [1.1, 2.2, 3.3, 4.4]
 */
o_inline oobj dvec3_json_new(oobj parent, const char *name, m_dvec3 dvec)
{
