 ...
 */
o_inline osize dmat4_buffer(char *str, osize size, m_dmat4 dmat, bool colored, bool typed, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline char *dmat4_str(oobj parent, m_dmat4 dmat, bool colored, bool typed, bool multiline)
{
    return dmatn_str(parent, dmat.v, 4, colored, typed, multiline);
}
#define dmat4_str_a(dmat, colored, typed, multiline) \
    dmat4_str(o_arena(), (dmat), (colored), (typed), (multiline))
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize dmat4_print(m_dmat4 dmat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize dmat4_println(m_dmat4 dmat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline bool dmat4_json_read(m_dmat4 *out_dmat, oobj json_array)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline oobj dmat4_json_new(oobj parent, const char *name, m_dmat4 dmat)
{
