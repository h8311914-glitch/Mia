 ...
 */
o_inline osize dvec2_buffer(char *str, osize size, m_dvec2 dvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the dvec<n> type (2..4)
 */
o_inline char *dvec2_str(oobj parent, m_dvec2 dvec, bool colored, bool typed)
{
    return dvecn_str(parent, dvec.v, 2, colored, typed);
}
#define dvec2_str_a(dvec, colored, typed) dvec2_str(o_arena(), (dvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize dvec2_print(m_dvec2 dvec)
{
 ...
 * @param n the size
 */
o_inline osize dvec2_println(m_dvec2 dvec)
{
 ...
 */
o_inline bool dvec2_json_read(m_dvec2 *out_dvec, oobj json_array)
{
 ...
 * @example json: [1.1, 2.2, 3.3, 4.4]
 */
o_inline oobj dvec2_json_new(oobj parent, const char *name, m_dvec2 dvec)
{
