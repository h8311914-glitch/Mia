 ...
 */
o_inline osize dmat2_buffer(char *str, osize size, m_dmat2 dmat, bool colored, bool typed, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline char *dmat2_str(oobj parent, m_dmat2 dmat, bool colored, bool typed, bool multiline)
{
    return dmatn_str(parent, dmat.v, 2, colored, typed, multiline);
}
#define dmat2_str_a(dmat, colored, typed, multiline) \
    dmat2_str(o_arena(), (dmat), (colored), (typed), (multiline))
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize dmat2_print(m_dmat2 dmat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize dmat2_println(m_dmat2 dmat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline bool dmat2_json_read(m_dmat2 *out_dmat, oobj json_array)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline oobj dmat2_json_new(oobj parent, const char *name, m_dmat2 dmat)
{
