 ...
 */
o_inline osize bvec3_buffer(char *str, osize size, m_bvec3 bvec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the bvec<n> type (2.)
 */
o_inline char *bvec3_str(oobj parent, m_bvec3 bvec, bool colored, bool typed)
{
    return bvecn_str(parent, bvec.v, 3, colored, typed);
}
#define bvec3_str_a(bvec, colored, typed) bvec3_str(o_arena(), (bvec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize bvec3_print(m_bvec3 bvec)
{
 ...
 * @param n the size
 */
o_inline osize bvec3_println(m_bvec3 bvec)
{
 ...
 */
o_inline bool bvec3_json_read(m_bvec3 *out_bvec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj bvec3_json_new(oobj parent, const char *name, m_bvec3 bvec)
{
