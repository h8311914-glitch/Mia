 ...
 */
o_inline osize ivec4_buffer(char *str, osize size, m_ivec4 ivec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the ivec<n> type (2.)
 */
o_inline char *ivec4_str(oobj parent, m_ivec4 ivec, bool colored, bool typed)
{
    return ivecn_str(parent, ivec.v, 4, colored, typed);
}
#define ivec4_str_a(ivec, colored, typed) ivec4_str(o_arena(), (ivec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize ivec4_print(m_ivec4 ivec)
{
 ...
 * @param n the size
 */
o_inline osize ivec4_println(m_ivec4 ivec)
{
 ...
 */
o_inline bool ivec4_json_read(m_ivec4 *out_ivec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj ivec4_json_new(oobj parent, const char *name, m_ivec4 ivec)
{
