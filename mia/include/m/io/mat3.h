 ...
 */
o_inline osize mat3_buffer(char *str, osize size, m_mat3 mat, bool colored, bool typed, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline char *mat3_str(oobj parent, m_mat3 mat, bool colored, bool typed, bool multiline)
{
    return matn_str(parent, mat.v, 3, colored, typed, multiline);
}
#define mat3_str_a(mat, colored, typed, multiline) \
    mat3_str(o_arena(), (mat), (colored), (typed), (multiline))
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize mat3_print(m_mat3 mat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize mat3_println(m_mat3 mat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline bool mat3_json_read(m_mat3 *out_mat, oobj json_array)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline oobj mat3_json_new(oobj parent, const char *name, m_mat3 mat)
{
