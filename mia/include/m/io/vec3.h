 ...
 */
o_inline osize vec3_buffer(char *str, osize size, m_vec3 vec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the vec<n> type (2..4)
 */
o_inline char *vec3_str(oobj parent, m_vec3 vec, bool colored, bool typed)
{
    return vecn_str(parent, vec.v, 3, colored, typed);
}
#define vec3_str_a(vec, colored, typed) vec3_str(o_arena(), (vec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize vec3_print(m_vec3 vec)
{
 ...
 * @param n the size
 */
o_inline osize vec3_println(m_vec3 vec)
{
 ...
 */
o_inline bool vec3_json_read(m_vec3 *out_vec, oobj json_array)
{
 ...
 * @example json: [1.1, 2.2, 3.3, 4.4]
 */
o_inline oobj vec3_json_new(oobj parent, const char *name, m_vec3 vec)
{
