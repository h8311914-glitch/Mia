 ...
 */
o_inline osize ivec3_buffer(char *str, osize size, m_ivec3 ivec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the ivec<n> type (2.)
 */
o_inline char *ivec3_str(oobj parent, m_ivec3 ivec, bool colored, bool typed)
{
    return ivecn_str(parent, ivec.v, 3, colored, typed);
}
#define ivec3_str_a(ivec, colored, typed) ivec3_str(o_arena(), (ivec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize ivec3_print(m_ivec3 ivec)
{
 ...
 * @param n the size
 */
o_inline osize ivec3_println(m_ivec3 ivec)
{
 ...
 */
o_inline bool ivec3_json_read(m_ivec3 *out_ivec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj ivec3_json_new(oobj parent, const char *name, m_ivec3 ivec)
{
