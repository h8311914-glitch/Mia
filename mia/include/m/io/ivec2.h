 ...
 */
o_inline osize ivec2_buffer(char *str, osize size, m_ivec2 ivec, bool colored, bool typed)
{
 ...
 * @param typed if true, prints with the ivec<n> type (2.)
 */
o_inline char *ivec2_str(oobj parent, m_ivec2 ivec, bool colored, bool typed)
{
    return ivecn_str(parent, ivec.v, 2, colored, typed);
}
#define ivec2_str_a(ivec, colored, typed) ivec2_str(o_arena(), (ivec), (colored), (typed))
 ...
 * @param n the size
 */
o_inline osize ivec2_print(m_ivec2 ivec)
{
 ...
 * @param n the size
 */
o_inline osize ivec2_println(m_ivec2 ivec)
{
 ...
 */
o_inline bool ivec2_json_read(m_ivec2 *out_ivec, oobj json_array)
{
 ...
 * @example json: [1, 2, 3, 4]
 */
o_inline oobj ivec2_json_new(oobj parent, const char *name, m_ivec2 ivec)
{
