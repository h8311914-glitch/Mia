 ...
 */
o_inline osize mat2_buffer(char *str, osize size, m_mat2 mat, bool colored, bool typed, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline char *mat2_str(oobj parent, m_mat2 mat, bool colored, bool typed, bool multiline)
{
    return matn_str(parent, mat.v, 2, colored, typed, multiline);
}
#define mat2_str_a(mat, colored, typed, multiline) \
    mat2_str(o_arena(), (mat), (colored), (typed), (multiline))
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize mat2_print(m_mat2 mat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline osize mat2_println(m_mat2 mat, bool multiline)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline bool mat2_json_read(m_mat2 *out_mat, oobj json_array)
{
 ...
 * @note printed transposed, so it matches C row major, even if this lib is column major!
 */
o_inline oobj mat2_json_new(oobj parent, const char *name, m_mat2 mat)
{
